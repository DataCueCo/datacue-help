...
Los banners son, probablemente, la parte que más resalta de tu página de Inicio. Por lo general, se muestran inmediatamente "above the fold" (en la parte principal), para atraer el interés de los usuarios a un producto o grupo de productos definido. Típicamente, estos serán colecciones, agrupadas por:

- Categorías de productos (por ejemplo: "pantalones").
- Marcas de productos.

Debido a su capacidad para llamar la atención, es muy importante que muestres banners realmente relevantes a tus visitas. Después de todo, si tus usuarios son diferentes, ¿por qué les muestras lo mismo? Para optimizar este importante espacio de tu Home, deja a DataCue el trabajo de seleccionar automáticamente qué banner atraerá mejor a cada usuario. Lograrás disminuir tu tasa de rebote y derivar tráfico hacia el resto de tus páginas.

::: tip Tip
¿Sabes qué tan exitosos son tus banners? DataCue te permite saberlo, pues te mostraremos qué tan bien convierte cada uno según las vistas y conversiones que tenga. Puedes también hacer pruebas. Por ejemplo,para una misma categoría, sube Banner A y Banner B. Los mostraremos en distintas ocasiones y te diremos cuál se desempeña mejor. Tendrás todos estos datos en tu Panel de control DataCue.
:::


## Inicio rápido

1. Antes de comenzar, debes saber que DataCue funciona con grillas de banners, no con sliders. Primero, revisa los diferentes tamaños de banner soportados por DataCue, para que diseñes tus imágenes con estas especificaciones. 
[Ir a Tipos de Banner](#tipos-de-banner).

2. Decide qué diseño, layout o disposición de banners funciona mejor para tu sitio. Puedes tomar uno de nuestros 3 templates, o crear el tuyo propio. Eres libre de pedirnos sugerencias, si así lo deseas. 
[Ir al Disposición de Banners](#disposicion-de-banners)

3. ¡Ahá! Ya leíste este manual, y tienes tus banners diseñados. Súbelos a tu plataforma DataCue.   
...
¿Cómo diseñar tus banners? Sigue leyendo para saber más sobre el tamaño que mejor te acomoda.
...
Este banner se sube desde tu Panel de Control DataCue, en la sección "Banner -> Agregar Banner"

### Banner angosto dinámico

![Tipos de banner](./images/banner-narrow.jpg)

Estos banners son más pequeños y nos permiten situarlos como un complemento al banner ancho. Después de seleccionar los banners anchos, en orden de relevancia buscaremos después todos los banners angostos que tu usuario pueda encontrar interesantes. En otras palabras, los banners anchos tienen prioridad.
...
### Banner ancho estático

![Tipos de banner](./images/banner-wide-static.jpg)

Entendemos que hay mensajes que quieres mantener uniformemente en tu sitio web. Por eso, creamos los banners estáticos. El banner estático por defecto en DataCue será ancho.
...
Tamaño recomendado: **1200 x 720 px**
Este banner se sube desde tu plataforma de e-commerce.
...
En este caso, tendrás 1 banner ancho estático (gris), 2 dinámicos anchos y 2 dinámicos angostos. Te sugerimos al menos 5 anchos y 5 angostos, de tus categorías más populares. 

### 4. Crea tu propia disposición y tamaño de banner

Si ninguno de los anteriores satisface tus necesidades, puedes crear tu propio tamaño de banner y diseño para disponerlos siguiendo la guía [aquí](https://help.datacue.co/es/install/advanced.html). En este caso, también te sugerimos que al menos uno de tus banners, sea cual sea el tamaño que elijas, sea estático. Este lo subirás directo desde tu plataforma. Los dinámicos, puedes subirlos desde tu Panel DataCue.
...
DataCue es como un miembro más en tu equipo de marketing. Te permitirá ahorrar tiempo, al decidir por ti qué banner llamará mejor la atención de tu usuario. Cuando ingrese un usuario por primera vez al sitio (o por primera vez en mucho tiempo), verá automáticamente los más populares. ¡Ya no debes preocuparte de seguir tantos calendarios de planificación! 

Por otro lado, DataCue te permite tener contenido útil. Queremos que te asegures de que todo en tu sitio favorece la conversión. Desde tu Panel de Control puedes ver qué tan efectivos son tus banners, obtener recomendaciones de acciones a tomar, y realizar tests A/B para probar qué banner funciona mejor para una misma categoría o producto. 
...
- Verás íconos bajo el banner que serán recomendaciones a tomar, por ejemplo, un mensaje de que debes cambiar un banner que no está desempeñándose bien. Sabrás cuáles son tus banners más exitosos en cada momento.
